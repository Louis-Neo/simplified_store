    ...
    return Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text("Classics", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500)),
        ),
        ...
        Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index){
              while(index <= 3){
                var product = classicProducts[index];
              ...
              return InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => ProductList(products: classicProducts, title: title)));
                },
                child: Padding(
                    padding: const EdgeInsets.only(left: 10.0, bottom: 25.0),
                    child: Container(
