...
class PhotographerBags extends StatelessWidget {

  static final _random = Random();

  var _randomPicture = premiumProducts[_random.nextInt(premiumProducts.length)];

  String title = "Photographers' Carriage";
    ...
    return Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text("Photographers' Carriage", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500)),
        ),
        ...
        Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index){
              while(index <= 3){
                var product = photographerProducts[index];
              ...
              return InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => ProductList(products: photographerProducts, title: title)));
                },
                child: Padding(
                    padding: const EdgeInsets.only(left: 10.0, bottom: 25.0),
                    child: Container(
