    ...
    return Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text("Gym Bags", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500)),
        ),
        ...
        Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index){
              ...
              return InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => ProductList(products: gymProducts, title: title)));
                },
                child: Padding(
                    padding: const EdgeInsets.only(left: 10.0, bottom: 25.0),
                    child: Container(
